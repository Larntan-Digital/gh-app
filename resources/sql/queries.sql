...
-- :name get-lendingparams :? :*
select param_value
from tbl_lending_params
...
(loan_request_id,subscriber_fk,cedis_requested,cedis_serviceq,max_loanable,loan_flags,loan_type,channel,ml_loan_counter)
values (:request-id,:subscriber,:amount,:serviceq,:max_loanable,:loan_flags,:loan_type::typ_loan_type,:channel,:loan_count)
